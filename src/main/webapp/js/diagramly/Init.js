...
window.uiTheme = window.uiTheme || (function () {
	...
	// Uses minimal theme on small screens 在小屏幕上显示最小的主题
	try {
		if (ui == null) {
			var iw = window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth

			// if (iw <= 0) // iw <= 768 zhaodeezhu 将移动端适配删除
			// {
	...
	// Redirects sketch UI to min UI with sketch URL parameter zhaodeezhu 暂时先去去掉看看是否还会出现小屏适配
	// if (ui == 'sketch')
	// {
	// 	urlParams['sketch'] = '1';
	// 	ui = 'min';
