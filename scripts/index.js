...
const client = ['js/deflate/base64', 'js/diagramly/Init', 'js/grapheditor/Init', 'mxgraph/mxClient', 'js/jscolor/jscolor'].map(item => joinPath('', item))
...
async function init() {
  ...
  // 需要编译
  await mergeFiles(basePath + '/js/app.min.js', baseMin, false)
